...
function SvgServerDown(props) {
  const { lightColor = '#3F3D56', darkColor = '#2F2E41' } = props;
  ...
  return (
    ...
    >
      ...
      <path d="M0 51.142c0 77.498 48.618 140.209 108.7 140.209" fill={darkColor} />
      <path
        d="M108.7 191.35c0-78.368 54.256-141.783 121.304-141.783M39.384 58.168c0 73.614 31.003 133.183 69.317 133.183"
        fill="#6c63ff"
      />
      <path d="M108.7 191.35c0-100.137 62.711-181.167 140.209-181.167" fill={darkColor} />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <ellipse cx={198.609} cy={424.5} rx={187} ry={25.44} fill={lightColor} />
      <ellipse cx={198.609} cy={424.5} rx={157} ry={21.359} opacity={0.1} />
      <ellipse cx={836.609} cy={660.5} rx={283} ry={38.5} fill={lightColor} />
      <ellipse cx={310.609} cy={645.5} rx={170} ry={23.127} fill={lightColor} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <rect x={578.433} y={212.689} width={513.253} height={357.52} rx={18.046} fill={darkColor} />
      <path fill={lightColor} d="M595.703 231.777h478.713v267.837H595.703z" />
      ...
      <path fill={darkColor} d="M108.609 159h208v242h-208z" />
      <path fill={lightColor} d="M87.609 135h250v86h-250zM87.609 237h250v86h-250zM87.609 339h250v86h-250z" />
      ...
      <circle cx={316.609} cy={538} r={79} fill={darkColor} />
      <path fill={darkColor} d="M280.609 600h24v43h-24zM328.609 600h24v43h-24z" />
      <ellipse cx={300.609} cy={643.5} rx={20} ry={7.5} fill={darkColor} />
      <ellipse cx={348.609} cy={642.5} rx={20} ry={7.5} fill={darkColor} />
      <circle cx={318.609} cy={518} r={27} fill="#fff" />
      <circle cx={318.609} cy={518} r={9} fill={lightColor} />
      <path
